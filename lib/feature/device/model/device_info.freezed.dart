...
class _$DeviceInfoImpl extends _DeviceInfo {
  ...
  @override
  String toString() {
    return 'DeviceInfo(connectionMode: $connectionMode, deviceId: $deviceId, ip: $ip, isRegistered: $isRegistered, hasContent: $hasContent, bluetoothBonded: $bluetoothBonded, bluetooth: $bluetooth, bluetoothId: $bluetoothId, volume: $volume, timezone: $timezone, deviceName: $deviceName)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.bluetoothBonded, bluetoothBonded) ||
                other.bluetoothBonded == bluetoothBonded) &&
